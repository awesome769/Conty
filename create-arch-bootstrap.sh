...
video_pkgs="mesa lib32-mesa vulkan-radeon lib32-vulkan-radeon \
	...
	lib32-glu nettle openal xdelta3 inotify-tools"
...
extra_pkgs="nano ttf-dejavu ttf-liberation jre8-openjdk jre17-openjdk jre21-openjdk mono-complete mangohud torbrowser-launcher openssh xsel obs-studio rsync"
