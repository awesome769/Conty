...
extra_pkgs="nano ttf-dejavu ttf-liberation jre8-openjdk jre17-openjdk jre21-openjdk mono-complete mangohud torbrowser-launcher openssh"
...
export aur_packagelist="heroic-games-launcher-bin jellyfin-media-player vesktop-bin vscodium-bin libfmod fmodstudio wine-tkg-staging-bin"
