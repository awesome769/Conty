...
AUR_PACKAGES=(lib32-openal heroic-games-launcher-bin vesktop-bin vscodium-bin lbry-desktop-bin lib32-openssl-1.0 mesen easyrpg-player-git duckstation-gpl)
